...
public class ComponentUtil {
	public static void success(Panel panel, String title){
		panel.setSclass("panel-info");
		panel.setTitle(title);
	}
	
	public static void failed(Panel panel, String title){
		panel.setSclass("panel-danger");
		panel.setTitle(title);
	}
