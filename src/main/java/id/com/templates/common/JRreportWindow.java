...
public class JRreportWindow extends Window implements Serializable {
    ...
    * @param type
    */
   public JRreportWindow(Component parent, boolean modal, HashMap<Object, 
		   Object> reportParams, String reportPathName, JRDataSource ds, 
		   String type, Connection conn, String nameFile) {
      super();
      this.parent = parent;
      this.modal = modal;
   ...
   public JRreportWindow(Component parent, HashMap<Object, 
		   Object> reportParams, String reportPathName, JRDataSource ds, 
		   String type, String nameFile) {
      super();
      this.parent = parent;
      this.reportParams = reportParams;
      this.reportPathName = reportPathName;
   ...
   private void createReport() throws FileNotFoundException {
      ...
      try {
         ...
         if(ds!=null){
            ...
            jp = JasperFillManager.fillReport(is,reportParams,connection);
         }
         ...
         if("xls".equals(type)){
            ...
            try {
               ...
               media = new AMedia(nameFile + ".xls",type,"application/vnd.ms-excel",jsReport);
            }finally {
               try {
                  bos.close();
               } catch (IOException e) {
            ...
            try {
               ...
               jsReport = bos.toByteArray();
               media = new AMedia(nameFile + ".csv",type,"text/csv",jsReport);
            }finally {
               try {
                  bos.close();
               } catch (IOException e) {
            ...
            try {
               ...
               jsReport = bos.toByteArray();
               media = new AMedia(nameFile + ".xls","xls","application/vnd.ms-excel",jsReport);
            }finally {
               try {
                  bos.close();
               } catch (IOException e) {
            ...
            try {
               ...
               jsReport = bos.toByteArray();
               media = new AMedia(nameFile + ".html","html","text/html",jsReport);
            }finally {
               try {
                  bos.close();
               } catch (IOException e) {
            ...
            try {
               ...
               jsReport = bos.toByteArray();
               media = new AMedia(nameFile + ".rtf","rtf","application/rtf",jsReport);
            }finally {
               try {
                  bos.close();
               } catch (IOException e) {
            ...
            try {
               ...
               media = new AMedia(nameFile,type,"application/pdf",bos.toByteArray());
            }finally {
               try {
                  bos.close();
               } catch (IOException e) {
            ...
            try {
               ...
               jsReport = bos.toByteArray();
               media = new AMedia(nameFile + ".odt","odt","application/vnd.oasis.opendocument.text",jsReport);
            }finally {
               try {
                  bos.close();
               } catch (IOException e) {
            ...
            try {
               ...
               jsReport = bos.toByteArray();
               media = new AMedia(nameFile + ".pdf","pdf","application/pdf",jsReport);
            }finally {
               try {
                  bos.close();
               } catch (IOException e) {
   ...
   public AMedia createReportDownload() throws FileNotFoundException {
	      if (reportPathName.isEmpty()) {
	         throw new FileNotFoundException(reportPathName);
	      }
